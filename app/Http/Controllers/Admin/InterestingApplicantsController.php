...
class InterestingApplicantsController extends Controller
{
    /**
    ...
    {
        $data['MainMenus'] = MenuSystem::where('menu_system_part', 'InterestingApplicants')->with('MainMenu')->first();
        ...
        if (Helper::CheckPermissionMenu('InterestingApplicants', '1')) {
            return view('admin.InterestingApplicants.interesting_applicants', $data);
        } else {
    ...
    public function lists(Request  $request)
    {
        $result = Driver::select(
            ...
            ->where('driver.driver_status_job_app', 5);
