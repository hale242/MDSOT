...
class ProductCategoryController extends Controller
{
    ...
    {
        $data['MainMenus'] = MenuSystem::where('menu_system_part', 'ProductCategory')->with('MainMenu')->first();
        ...
        $data['PageContract'] = 'D';
        $data['PageProductCategory'] = 'D';
        if (Helper::CheckPermissionMenu('ProductCategory', '1')) {
