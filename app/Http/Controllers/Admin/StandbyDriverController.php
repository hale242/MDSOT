...
class StandbyDriverController extends Controller
{
    /**
    ...
    {
        $data['MainMenus'] = MenuSystem::where('menu_system_part', 'StandbyDriver')->with('MainMenu')->first();
        ...
        $data['PageContract'] = 'D';
        $data['PageStandbyDriver'] = 'D';

        if (Helper::CheckPermissionMenu('StandbyDriver', '1')) {
            return view('admin.StandbyDriver.standby_driver', $data);
        } else {
