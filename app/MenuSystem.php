...
class MenuSystem extends Model
{
    ...
    public function scopeActiveMenu($a){
        ...
        $PermissionActionByGroups = PermissionActionByGroup::join('department_admin_user', 'department_admin_user.department_id', 'permission_action_by_group.department_id')
