        ...
        <div class="material-card card">
            <div class="card">
                ...
                <div class="table-responsive">
                    <table id="tableApplicantsAppointment" class="table">
                        <thead>
                            <tr>
...
@section('scripts')
<script>
    var tableApplicantsAppointment = $('#tableApplicantsAppointment').dataTable({
        "ajax": {
            "url": url_gb + "/admin/ApplicantsAppointment/Lists",
            "type": "POST",
            "data": function(d) {
    ...
    $('body').on('click', '.btn-search', function(data) {
        tableJobApplicantsAppointment.api().ajax.reload();
    });
