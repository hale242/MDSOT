...
@include('admin.ApproveNewDriver.Modal.modal_reject')
@include('admin.ApproveNewDriver.Modal.modal_approve')
@include('admin.ApproveNewDriver.Modal.modal_not_approve')
@endsection
@section('scripts')
<script>
    var tableInterview = $('#tableInterview').dataTable({
        "ajax": {
            "url": url_gb + "/admin/ApproveNewDriver/Lists",
            "type": "POST",
            "data": function(d) {
...
@include('admin.ApproveNewDriver.Script.script_reject')
@include('admin.ApproveNewDriver.Script.script_approve')
@include('admin.ApproveNewDriver.Script.script_not_approve')
@endsection