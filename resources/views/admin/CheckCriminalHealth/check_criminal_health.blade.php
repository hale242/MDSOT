                ...
                <div class="collapse" id="collapseExample">
                    <form id="FormSearch" class="needs-validation" novalidate>
                        <div class="row pt-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="search_recruitment_position_id">ตำแหน่งงาน</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="search_driver_interview_criminal_date">วันนัดตรวจประวัติ</label>
                                    <input type="date" id="search_driver_interview_criminal_date" class="form-control search_table">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <div class="action-tables">
                        ...
                        <a href="javascript:void(0)" class="pr-3 btn-approve-all">
                            <span class="badge badge-success"><i class="ti-check"></i></span> Approve
                        </a>
                        <a href="javascript:void(0)" class="pr-3 btn-not-approve-all">
                    ...
                    <table id="tableInterview" class="table" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">วันนัดตรวจประวัติ</th>
                                <th scope="col">Interview date</th>
                                <th scope="col">คะแนนการสัมภาษณ์</th>
...
@include('admin.CheckCriminalHealth.Modal.modal_criminal_record')
@include('admin.CheckCriminalHealth.Modal.modal_health')
@endsection
@section('scripts')
<script>
    var tableInterview = $('#tableInterview').dataTable({
        "ajax": {
            "url": url_gb + "/admin/CheckCriminalHealth/Lists",
            "type": "POST",
            "data": function(d) {
                d.driver_name = $('#search_driver_name').val(),
                    ...
                    d.driver_interview_criminal_date = $('#search_driver_interview_criminal_date').val(),
        ...
        "columns": [{
            ...
            {
                "data": "driver_interview_criminal_date",
                "class": "text-right",
                "searchable": false,
                "sortable": false,
            },
    ...
    $('body').on('click', '.btn-clear-search', function(data) {
        ...
        $('#search_driver_interview_criminal_date').val('');
        $('#search_driver_status_job_app').val('').change();
        tableInterview.api().ajax.reload();
    });
</script>
@include('admin.JobRegister.Script.script_job_register_view')
@include('admin.CheckCriminalHealth.Script.script_approve')
@include('admin.CheckCriminalHealth.Script.script_criminal_record')
@include('admin.CheckCriminalHealth.Script.script_health')
@endsection