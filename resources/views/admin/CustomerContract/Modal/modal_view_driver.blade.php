<div class="modal fade" id="ModalViewDriver" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <input type="hidden" id="view_driver_quotation_id">
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table id="tableBackOrderSpec" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="text-center">#</th>
                                                <th scope="col" class="text-center">Firstname - Lastname</th>
