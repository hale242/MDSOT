        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label">Days of leave applicant</label>
                            <input type="date" id="search_driver_leave_approve_date_sent_approve" class="form-control search_table">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
        ...
        <div class="material-card card">
            <div class="card">
                <div class="card-body">
                    ...
                    @if(App\Helper::CheckPermissionMenu('DriverLeaveApprove' , '2'))
                    @endif
                </div>
                <div class="table-responsive">
                    <table id="tableDriverLeaveApprove" class="table">
                        <thead>
                            <tr>
                                <th scope="col">No</th>
...
@endsection
@section('modal')
@include('admin.DriverLeaveApprove.Modal.modal_approve')
...
@section('scripts')
<script>
    var tableDriverLeaveApprove = $('#tableDriverLeaveApprove').dataTable({
        "ajax": {
            "url": url_gb + "/admin/DriverLeaveApprove/Lists",
            "type":"POST", "data": function( d ) {
                ...
                d.driver_leave_approve_date_sent_approve = $('#search_driver_leave_approve_date_sent_approve').val();
        ...
        "columns": [
            ...
            {"data" : "driver_lastname_th" , "name":"driver.driver_lastname_th", "visible": false},
            {"data" : "leave_type_name", "name":"leave_type.leave_type_name"},
            {"data" : "type_name", "searchable": false, "sortable": false},
            {"data" : "driver_leave_line_branch_name", "name":"driver_leave_line_branch.driver_leave_line_branch_name"},
            {"data" : "driver_making_leave_name"},
            {"data" : "driver_making_leave_start_date", "class":"text-center" , "searchable": false},
            {"data" : "driver_making_leave_end_date", "class":"text-center" , "searchable": false},
            {"data" : "driver_making_leave_count_date", "class":"text-center"},
            {"data" : "driver_leave_approve_date_sent_approve", "class":"text-center" , "searchable": false},
            {"data" : "status_name", "class":"text-center" , "searchable": false},
            // {
            //     "data" : "line_approve" ,
            //     "name" : "line_approve",
            //     "searchable": false,
...
@include('admin.DriverLeaveApprove.Script.script_approve')
