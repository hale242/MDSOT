        ...
        <div class="material-card card">
            <div class="card">
                ...
                <div class="table-responsive">
                    <table id="tableInterestingApplicants" class="table">
                        <thead>
                            <tr>
...
@section('scripts')
<script>
    var tableInterestingApplicants = $('#tableInterestingApplicants').dataTable({
        "ajax": {
            "url": url_gb + "/admin/InterestingApplicants/Lists",
    ...
    $('body').on('click', '.btn-search', function(data) {
        tableJobInterestingApplicants.api().ajax.reload();
    });
