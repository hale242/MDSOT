                ...
                <div class="collapse" id="collapseExample">
                    <form id="FormSearch" class="needs-validation" novalidate>
                        <div class="row pt-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="search_driver_id_card_no">เลขบัตรประชาชน</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="search_driver_mobile_phone">โทรศัพท์มือถือ</label>
                                    <input type="text" class="form-control" id="search_driver_mobile_phone">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
        ...
        <div class="material-card card">
            <div class="card">
                ...
                <div class="table-responsive">
                    <table id="tableJobRegister" class="table">
                        <thead>
                            <tr>
...
<script>
    var tableJobRegister = $('#tableJobRegister').dataTable({
        "ajax": {
            "url": url_gb + "/admin/JobRegister/Lists",
            "type": "POST",
            "data": function(d) {
                ...
                d.driver_mobile_phone = $('#search_driver_mobile_phone').val();
            }
        },
    ...
    $('body').on('click', '.btn-clear-search', function(data) {
        ...
        $('#search_driver_mobile_phone').val('');
        tableJobRegister.api().ajax.reload();
    });
...
@include('admin.JobRegister.Script.script_interview_date')
