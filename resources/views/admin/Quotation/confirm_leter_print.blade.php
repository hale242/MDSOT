...
<body>
    <table width="100%">
        ...
        <tr>
            <td colspan="2">Dear &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$quotation->Customer ? $quotation->Customer->customer_name : ''}}</td>
            <td></td>
        </tr>
        <tr>
            <td colspan="2"></td>
    ...
    <table width="100%">
        <tr>
            <td width="11%" valign="top"><b>Remark</b> :</td>
            <td> <b> 1.__________ </b> </td>
        </tr>
        <tr>
            <td width="11%" valign="top"></td>
            <td> <b> 2.__________ </b> </td>
        </tr>
        <tr>
            <td width="11%" valign="top"></td>
            <td> <b> 3.__________ </b> </td>
        </tr>
        <tr>
            <td width="11%" valign="top"></td>
            <td> <b> 4.__________ </b> </td>
        </tr>
    </table>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td valign="top" class="text-center">
              <p> Acceptance of the offers : </p>
              <b>{{$quotation->Company ? $quotation->Company->company_name_th : ''}}</b>
              <br><br><br>
            </td>
            <td></td>
        </tr>
        <tr>
          <td valign="top" width="40%">
            ...
            Ms.Sirikarn Tantirittisak <br />
            Corporate Driver Manager <br />
              Sales representatime : (ชื่อเซลล์) <br />
              Mobile : (เบอร์โทรเซลล์)<br />
              E-mail : (e-mail เซลล์)
          </td>
          <td valign="top" class="text-center" width="40%">
            ____________________ <br />
